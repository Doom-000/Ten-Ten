    ...
    <div className="relative min-h-screen bg-[#040905] text-white flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden font-sans">
      ...
      {cropImageSrc && (
        <div className="fixed inset-0 bg-slate-950/85 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#1e293b] rounded-xl max-w-2xl w-full p-6 text-white shadow-2xl overflow-hidden flex flex-col gap-6 animate-in fade-in zoom-in-95 duration-200 panel-card">
            ...
            <div className="flex flex-col items-center gap-4">
              <div 
                ...
                className="relative bg-slate-950 rounded-lg overflow-hidden cursor-move select-none shadow-inner panel-card"
