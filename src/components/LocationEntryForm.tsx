...
export default function LocationEntryForm({ onSaveLocation }: LocationEntryFormProps) {
  ...
  return (
    <div className="bg-white dark:bg-[#121614] rounded-2xl shadow-xl panel-card overflow-hidden">
      <div className="p-6 md:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="p-5 rounded-xl panel-card bg-blue-50/50 dark:bg-blue-950/10 space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              {photos.map(photo => (
                <div key={photo.id} className="relative group w-24 h-24 sm:w-28 sm:h-28 rounded-xl overflow-hidden panel-card">
              ...
              {photos.length < 5 && (
                <div className="flex gap-2">
                  <button
                    ...
                    className="w-24 h-24 sm:w-28 sm:h-28 rounded-xl panel-card flex flex-col items-center justify-center gap-2 text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all"
                  >
