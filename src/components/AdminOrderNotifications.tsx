        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-[#121614] rounded-xl shadow-xl z-50 overflow-hidden panel-card"
            >
          ...
          {selectedOrder && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              <motion.div
                ...
                className="relative w-full max-w-lg bg-white dark:bg-[#121614] rounded-2xl shadow-2xl panel-card overflow-hidden flex flex-col max-h-[85vh]"
              >
